...
var _default = function _default(app) {
  ...
  getFileRoutes(options.routes).forEach(function (route) {
    ...
    route.methods.forEach(function (method) {
      appRoute[method](function (req, res) {
        var responses = Array.isArray(route.responses) ? route.responses : [];
        var respId = getRespCache()[route.id];
        if (respId !== undefined) {
          var resp = route.responses[respId];
  ...
  app.get('/_responses/:id', function (req, res) {
    var id = req.params.id;
    var fileRoute = getFileRoutes(options.routes).find(function (r) {
      return r.id === id;
    }) || {};
    var responses = (fileRoute.responses || []).map(function (response) {
  ...
  app.get('/_activate-response/:routeId/:respId', function (req, res) {
  ...
  app.get('/_deactivate-response/:routeId', function (req, res) {
...
(function () {
  ...
  reactHotLoader.register(respCache, 'respCache', 'src/api-route-provider.js');
  reactHotLoader.register(getRespCache, 'getRespCache', 'src/api-route-provider.js');
  reactHotLoader.register(setRespCache, 'setRespCache', 'src/api-route-provider.js');
