...
var _default = function _default(app) {
  ...
  getFileRoutes(options.routes).forEach(function (route) {
    ...
    var appRoute = app.route(route.path); // add methods to route
  ...
  app.get('/_grep', function (req, res) {
    ...
    var serverDirs = dirsToArray(options.server); // convert to array of objects
    ...
    var matchedFiles = Object.keys(files).sort().map(function (key) {
      ...
      var startLineNo = 1; // if only single line, show code window rather than entire file
...
function getFileRoutes(dir) {
  if (!dir) return [];
  return _glob["default"].sync("".concat(dir, "/**/*.+(js|json)")).filter(function (file) {
    // ignore fixtures
...
function getAPIRoutes(app) {
  ...
  return routes // ignore paths that start with /_ and the catchall
  .filter(function (r) {
...
function findPathInSrc(options, path) {
  ...
  srcDirs.forEach(function (dir) {
    ...
    var search = partsPattern.join(' | '); // execute, convert to array, filter blanks
...
(function () {
  ...
  reactHotLoader.register(execSync, "execSync", "/Users/davidadams/code/headlamp/src/api-route-provider.js");
  reactHotLoader.register(warnDuplicateRoutes, "warnDuplicateRoutes", "/Users/davidadams/code/headlamp/src/api-route-provider.js");
  reactHotLoader.register(createActivationStore, "createActivationStore", "/Users/davidadams/code/headlamp/src/api-route-provider.js");
  reactHotLoader.register(createCustomResponseStore, "createCustomResponseStore", "/Users/davidadams/code/headlamp/src/api-route-provider.js");
  reactHotLoader.register(getRouteResponses, "getRouteResponses", "/Users/davidadams/code/headlamp/src/api-route-provider.js");
  reactHotLoader.register(getRouteHeaders, "getRouteHeaders", "/Users/davidadams/code/headlamp/src/api-route-provider.js");
  reactHotLoader.register(callIfFunc, "callIfFunc", "/Users/davidadams/code/headlamp/src/api-route-provider.js");
  reactHotLoader.register(getFileRoutes, "getFileRoutes", "/Users/davidadams/code/headlamp/src/api-route-provider.js");
  reactHotLoader.register(getRouteId, "getRouteId", "/Users/davidadams/code/headlamp/src/api-route-provider.js");
  reactHotLoader.register(getAPIRoutes, "getAPIRoutes", "/Users/davidadams/code/headlamp/src/api-route-provider.js");
  reactHotLoader.register(parseFileAndLineNo, "parseFileAndLineNo", "/Users/davidadams/code/headlamp/src/api-route-provider.js");
  reactHotLoader.register(dirsToArray, "dirsToArray", "/Users/davidadams/code/headlamp/src/api-route-provider.js");
  reactHotLoader.register(findPathInSrc, "findPathInSrc", "/Users/davidadams/code/headlamp/src/api-route-provider.js");
  reactHotLoader.register(findPathInServer, "findPathInServer", "/Users/davidadams/code/headlamp/src/api-route-provider.js");
  reactHotLoader.register(createSrcPathRegExp, "createSrcPathRegExp", "/Users/davidadams/code/headlamp/src/api-route-provider.js");
  reactHotLoader.register(nthIndex, "nthIndex", "/Users/davidadams/code/headlamp/src/api-route-provider.js");
  reactHotLoader.register(_default, "default", "/Users/davidadams/code/headlamp/src/api-route-provider.js");
})();
